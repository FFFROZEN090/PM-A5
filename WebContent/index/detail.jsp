		...
		<div class="container">
			<div class="single-grids">				
				...
				<div class="col-md-4 single-grid simpleCart_shelfItem">		
					<h3>${good.name}</h3>
					<div class="tag">
						<p>classification : <a href="goods?typeid=${good.type.id}">${good.type.name}</a></p>
					</div>
					<p>introduction: ${good.intro}</p>
					<div class="galry">
						<div class="prices">
					...
					<div class="btn_form">
						<a href="javascript:;" class="add-cart item_add" onclick="buy(${good.id})">add to cart</a>	
					</div>
				</div>
