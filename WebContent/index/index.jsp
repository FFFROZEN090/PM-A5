...
<html>
<head>
	<title>Welcome to the beverage store management system!</title>
...
<body>
	...
	<c:forEach var="top" items="${top1List}" end="0">
		<div class="banner">
			<div class="container">
				...
				<a class="banner_a" href="javascript:;" onclick="buy(${top.good.id})">add to cart</a>
	...
	<div class="gallery">
		<div class="container">
			<div class="alert alert-danger">hot selling recommendation</div>
					...
					<div class="col-md-4 gallery-grid glry-two">
						...
						<div class="gallery-info galrr-info-two">
							<p>
								...
								<a href="detail?goodid=${top.good.id}">view details</a>
							</p>
							<a class="shop" href="javascript:;" onclick="buy(${top.good.id})">add to cart</a>
