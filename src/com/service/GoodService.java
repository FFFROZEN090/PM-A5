...
public class GoodService {
	...
	/**
	 * 获取产品总数 Get the total number of products
	 * @return
	 */
	...
	/**
	 * 通过名称获取产品列表 Get product list by name
	 * @param page
	 * @param size
	 * @return
	 */
	...
	/**
	 * 通过名称获取产品总数 Get the total number of products by name
	 * @return
	 */
	...
	/**
	 * 封装商品推荐信息 Package product recommendation information
	 * @param list
	 * @return
	 */
